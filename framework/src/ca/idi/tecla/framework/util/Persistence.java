...
public class Persistence {
	...
	public static final String PREF_TECLA_CONTROL = "tecla_control";
	...
	private boolean mScreenOn, mInverseScanningChanged, mVariantsKeyOn,
			mVariantsShowing,mTeclaForeground;
	...
	public HashMap<String, String[]> getSwitchMap() {
		...
		mSwitchMap.put(
				PREF_SWITCH_J1,
				new String[] {
						shared_prefs.getString(PREF_SWITCH_J1_TECLA, "1"),
						shared_prefs.getString(PREF_SWITCH_J1_MORSE, "1") });
		mSwitchMap.put(
				PREF_SWITCH_J2,
				new String[] {
						shared_prefs.getString(PREF_SWITCH_J2_TECLA, "2"),
						shared_prefs.getString(PREF_SWITCH_J2_MORSE, "2") });
		mSwitchMap.put(
				PREF_SWITCH_J3,
				new String[] {
						shared_prefs.getString(PREF_SWITCH_J3_TECLA, "3"),
						shared_prefs.getString(PREF_SWITCH_J3_MORSE, "3") });
		mSwitchMap.put(
				PREF_SWITCH_J4,
				new String[] {
						shared_prefs.getString(PREF_SWITCH_J4_TECLA, "4"),
						shared_prefs.getString(PREF_SWITCH_J4_MORSE, "4") });
		mSwitchMap.put(
				PREF_SWITCH_E1,
				new String[] {
						shared_prefs.getString(PREF_SWITCH_E1_TECLA, "4"),
						shared_prefs.getString(PREF_SWITCH_E1_MORSE, "0") });
		mSwitchMap.put(
				PREF_SWITCH_E2,
				new String[] {
						shared_prefs.getString(PREF_SWITCH_E2_TECLA, "3"),
	...
	public void setTeclaForegroundOn(){
		mTeclaForeground = true;
	}
	public void setTeclaForegroundOff(){
		mTeclaForeground = false;
	}
	public boolean isTeclaForegroundOn(){
		return mTeclaForeground;
	}
